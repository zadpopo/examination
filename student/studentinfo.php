...
$q1 ="select concat(`FirstName`,' ',`MiddleName`,' ',`LastName`,' ',Suffix) as 'Name' from studenttbl where student_number  ='$user'";
...
$query1= "SELECT * FROM enrolltbl WHERE student_number='$user'";
...
$query= "SELECT * FROM transactiontbl WHERE stud_id='$user'";
